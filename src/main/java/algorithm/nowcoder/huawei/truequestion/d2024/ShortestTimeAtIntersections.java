...
import algorithm.leetcode.medium.s.Solution;

import java.util.PriorityQueue;
import java.util.Scanner;

// 路口最短时间问题
public class ShortestTimeAtIntersections {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                new ShortestTimeAtIntersections().calcTime(lights, timePreRoad, rowStart, colStart, rowEnd, colEnd));
    }
